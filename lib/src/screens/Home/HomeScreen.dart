                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Enjoy home made food close to you',
                        style: TextStyle(
                            fontFamily: 'Montserrat',
                            fontSize: 16.0,
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              _buildFoodCard('Red Valenzuela', 'Mexican Food!', 'assets/redChef.png'),
                              _buildFoodCard('Valentina', 'Venezuelan Food!', 'assets/valeChef.png'),
                              _buildFoodCard('Rodo', 'Swiss Food', 'assets/greensalad.png')
                            ],
                          )
                      ),
